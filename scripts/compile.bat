...
set OUT_EXE=%~dp0..\AutoAG_Tray.exe
set SRC_CS=%~dp0..\src\tray\Program.cs
set SRC_ICON_GEN=%~dp0..\src\tray\MakeIcon.cs
set OUT_ICON_EXE=%~dp0..\src\tray\MakeIcon.exe
set ICO_FILE=%~dp0..\src\tray\Resources\logo.ico
...
"%COMPILER%" /target:winexe %ICON_FLAG% /resource:"%~dp0..\src\tray\Resources\logo.ico",AutoAG_CLI.logo.ico /resource:"%~dp0..\src\tray\Resources\logo_disabled.ico",AutoAG_CLI.logo_disabled.ico /out:"%OUT_EXE%" /r:System.dll,System.Drawing.dll,System.Windows.Forms.dll "%SRC_CS%"
